---
title: Replacing ember-data in place
description: Replace ember-data 4.12 with the latest @warp-drive/* packages in one change, keeping the single store and the existing Models, adapters and serializers running, then convert to schemas and request builders at your own pace.
outline:
  level: 2,3
---
...
<SinceBadge version="5.10.0" /> &nbsp; authored 2026-09-26
