...
| --- | --- | --- | --- | --- | --- | --- |
| ✅ | Canary | ![NPM canary Version](https://img.shields.io/npm/v/ember-data/canary?label&color=90EE90) | `6.4` | `4.8`<br>`4.12`<br>`5.*`<br>`6.*` | `3.28`<br>`4.12`<br>`5.12`<br>`6.12` | `3.28.12`<br>`>= 4.*`<br>`>= 5.*`<br>`>= 6.*` |
| ✅ | Beta | ![NPM beta Version](https://img.shields.io/npm/v/ember-data/beta?label&color=90EE90) | `6.4` | `4.8`<br>`4.12`<br>`5.*`<br>`6.*` | `3.28`<br>`4.12`<br>`5.12`<br>`6.12` | `3.28.12`<br>`>= 4.*`<br>`>= 5.*`<br>`>= 6.*` |
| ✅ | Latest (Stable) | ![NPM latest Version](https://img.shields.io/npm/v/ember-data/latest?label&color=90EE90) | `>= 5.3`<br>`6.0`<br>`6.1`<br>`6.2`<br>`6.3` | `4.8`<br>`4.12`<br>`5.*`<br>`6.*` | `3.28`<br>`4.12`<br>`5.12`<br>`6.12` | `3.28.12`<br>`>= 4.*`<br>`>= 5.*`<br>`>= 6.*` |
| ✅ | LTS | ![NPM lts Version](https://img.shields.io/npm/v/ember-data/lts?label&color=90EE90) | `>= 5.3`<br>`6.0`<br>`6.1`<br>`6.2`<br>`6.3` | `4.8`<br>`4.12`<br>`5.*`<br>`6.*` | `3.28`<br>`4.12`<br>`5.12`<br>`6.12` | `3.28.12`<br>`>= 4.*`<br>`>= 5.*`<br>`>= 6.*` |
