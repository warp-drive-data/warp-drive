---
title: Caddy
description: Put Caddy in front of the Vite dev server and holodeck, so the test page is served over HTTPS on one origin with the certificate holodeck already has.
---
