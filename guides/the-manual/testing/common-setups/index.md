---
title: Common Setups
description: Serve the test page and the holodeck mock server from one origin, so mocked requests need no CORS and no preflight, with the forwarder that Vite, testem, and Caddy setups share.
---
