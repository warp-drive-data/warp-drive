---
title: Migrating from Mirage to Holodeck
description: Convert an ember-cli-mirage or miragejs test suite to Holodeck mocks one test at a time, with fixtures committed under .mock-cache and replay enforced in CI.
---
