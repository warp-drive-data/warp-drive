---
title: 7. Delete
description: Write a deleteTodo builder with the deleteRecord op, send it from the × button and from an emptied title, and let the cache drop the todo from every list.
---
