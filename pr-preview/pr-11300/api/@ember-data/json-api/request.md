---
url: >-
  https://canary.warp-drive.io/pr-preview/pr-11300/api/@ember-data/json-api/request.md
description: >-
...
`@ember-data/json-api` is a legacy package. New code should use [`@warp-drive/json-api`](/api/@warp-drive/json-api/) instead.
:::
