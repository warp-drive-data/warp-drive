---
url: https://canary.warp-drive.io/pr-preview/pr-11296/api/@warp-drive/holodeck.md
description: >-
  Experimental HTTP mocking for tests that makes real network requests and
  replays git-managed recordings, via `MockServerHandler` and the `GET`/`POST`
  helpers in `@warp-drive/holodeck/mock`.
---
