---
url: >-
  https://canary.warp-drive.io/pr-preview/pr-11248/guides/the-manual/relational-data/mutating/adding-removing.md
description: >-
  How to add, remove, and replace related records on an editable record,
  including checkout for PolarisMode records and the legacy belongsTo and
  hasMany APIs.
---
