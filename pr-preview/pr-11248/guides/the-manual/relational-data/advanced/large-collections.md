---
url: >-
  https://canary.warp-drive.io/pr-preview/pr-11248/guides/the-manual/relational-data/advanced/large-collections.md
description: >-
  When a list is too large for a collection relationship, how to load it as its
  own request instead, and how maxCollectionRelationshipSize enforces the limit.
---
