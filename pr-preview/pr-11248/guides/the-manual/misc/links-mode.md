---
url: >-
  https://canary.warp-drive.io/pr-preview/pr-11248/guides/the-manual/misc/links-mode.md
description: >-
  How LinksMode lets a legacy belongsTo or hasMany relationship load through
  store.request instead of an adapter, and the constraints it carries in
  LegacyMode and PolarisMode.
---
