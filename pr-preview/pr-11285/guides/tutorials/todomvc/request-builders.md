---
url: >-
  https://canary.warp-drive.io/pr-preview/pr-11285/guides/tutorials/todomvc/request-builders.md
description: >-
  Write builders for the all, active and completed lists, use them in the routes
  and the footer, then move the JSON:API headers into a handler.
---
