---
url: >-
  https://canary.warp-drive.io/pr-preview/pr-11285/guides/tutorials/todomvc/bulk-operations.md
description: >-
  Toggle every todo and clear the completed ones with one request each, update
  the cache yourself when the response has no todos, then see where to go next.
---
