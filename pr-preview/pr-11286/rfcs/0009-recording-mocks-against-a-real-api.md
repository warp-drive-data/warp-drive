---
url: >-
  https://canary.warp-drive.io/pr-preview/pr-11286/rfcs/0009-recording-mocks-against-a-real-api.md
description: >-
  Holodeck tests can record fixtures from a real API through a relay route that
  keeps credentials on the server, with safety protocols that validate and
  sanitize every response before it is committed.
---
