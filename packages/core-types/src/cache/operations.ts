 ...
 *
 * @summary Legacy alias re-exporting `@warp-drive/core/types/cache/operations`, the operations that add, update, merge,
 * and remove cache data; new code should import from there.
 * @module
 */
