...
export default [
  ...
  typescript.browser({
    ...
    // needs to run the type-aware rules oxlint now owns for these files. This directory has no
    // `.gts` sources today (oxlint's parser can't scan those), so this is safe; if that
