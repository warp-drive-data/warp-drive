...
module('Integration | <JSONAPICache> hash equality of schema-object values', function () {
  ...
  test('re-pushing a schema-array with a changed hashed field notifies both channels', function (assert) {
    ...
    // an upsert with no local edit announces the key unscoped, which reaches both channels
