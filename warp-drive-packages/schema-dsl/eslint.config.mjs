...
export default [
  ...
  typescript.browser({
    ...
    // covers `src`'s .ts files cleanly — the only findings here were in vite-plugin.js, an
    // untyped plain .js file oxlint no longer type-checks (see .oxlintrc.json's "**/*.js"
    // override) — verified against real CI's type-aware run.
