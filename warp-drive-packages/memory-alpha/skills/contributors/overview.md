...
| Write or change documentation — a TSDoc comment, a guide, an `upgrading/` or `blog/` page, a README, or an agent skill | [Write Documentation](/skills/contributors/write-documentation.md) |
