 ...
 * - `async: true` relationships are supported (but not recommended outside of [LinksMode](/guides/the-manual/relational-data/features/links-mode.md))
 *
 * ---
 *
 ...
 * - `async: true` relationships are not supported (see [LinksMode](/guides/the-manual/relational-data/features/links-mode.md))
