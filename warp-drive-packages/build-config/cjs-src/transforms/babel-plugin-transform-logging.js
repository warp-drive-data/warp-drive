          ...
          specifiers.forEach((specifier) => {
            ...
            binding.referencePaths.forEach((p) => {
              ...
              node.replaceWith(
                ...
                // }
                // =>
                // if (macroCondition(getConfig().debug.LOG_FOO)) {
                //     // ...
                // }
              ...
              if (enableRuntimeActivation) {
                ...
                // }
                // =>
                // if (macroCondition(getConfig().activeLogging.LOG_FOO)) {
                //   if (getConfig().debug.LOG_FOO || globalThis.getWarpDriveRuntimeConfig().debug.LOG_FOO) {
                //     // ...
                //   }
                // }
                //
