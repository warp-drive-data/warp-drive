 ...
 * ```
 *
 * @summary Builds a `DELETE` request that persists deletion of an existing record, using REST-style URLs.
 * @public
 * @param record
 * @param options
 */
 ...
 * ```
 *
 * @summary Builds a `POST` request that saves a newly created record, using REST-style URLs.
 * @public
 * @param record
 * @param options
 */
 ...
 * ```
 *
 * @summary Builds a `PUT` (or `PATCH`) request that saves changes to an existing record, using REST-style URLs.
 * @public
 * @param record
 * @param options
 */
